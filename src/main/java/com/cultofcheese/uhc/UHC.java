...
public class UHC extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        registerListeners(new JoinListener(), new StatsListener(), new WorldLoadListener(), new ConfigMenuListener(), new DamageHungerListener(), new WeatherListener(), new LeaveListener(), new DamageListener());
